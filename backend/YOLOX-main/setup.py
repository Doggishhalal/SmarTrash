...
def get_install_requirements():
    ...
    # filter out commented lines and problematic optional packages that
    # cause build-time compilation (onnx-simplifier in particular)
    reqs = [x for x in reqs if not x.startswith("#") and "onnx-simplifier" not in x]
    return reqs
